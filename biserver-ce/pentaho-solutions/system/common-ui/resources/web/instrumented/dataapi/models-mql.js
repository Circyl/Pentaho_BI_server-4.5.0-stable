...
if (! _$jscoverage['dataapi/models-mql.js']) {
  ...
  _$jscoverage['dataapi/models-mql.js'][768] = 0;
  _$jscoverage['dataapi/models-mql.js'][769] = 0;
  _$jscoverage['dataapi/models-mql.js'][770] = 0;
  _$jscoverage['dataapi/models-mql.js'][771] = 0;
  ...
  _$jscoverage['dataapi/models-mql.js'][781] = 0;
  _$jscoverage['dataapi/models-mql.js'][782] = 0;
  ...
  _$jscoverage['dataapi/models-mql.js'][845] = 0;
  _$jscoverage['dataapi/models-mql.js'][846] = 0;
  _$jscoverage['dataapi/models-mql.js'][847] = 0;
  _$jscoverage['dataapi/models-mql.js'][849] = 0;
  _$jscoverage['dataapi/models-mql.js'][853] = 0;
  _$jscoverage['dataapi/models-mql.js'][854] = 0;
  _$jscoverage['dataapi/models-mql.js'][855] = 0;
  _$jscoverage['dataapi/models-mql.js'][857] = 0;
  _$jscoverage['dataapi/models-mql.js'][858] = 0;
  _$jscoverage['dataapi/models-mql.js'][859] = 0;
  _$jscoverage['dataapi/models-mql.js'][860] = 0;
  _$jscoverage['dataapi/models-mql.js'][861] = 0;
  ...
  _$jscoverage['dataapi/models-mql.js'][869] = 0;
  _$jscoverage['dataapi/models-mql.js'][870] = 0;
  ...
  _$jscoverage['dataapi/models-mql.js'][878] = 0;
  _$jscoverage['dataapi/models-mql.js'][879] = 0;
  ...
  _$jscoverage['dataapi/models-mql.js'][889] = 0;
  ...
  _$jscoverage['dataapi/models-mql.js'][921] = 0;
...
pentaho.pda.query.mql.prototype.serialize = (function () {
  ...
  _$jscoverage['dataapi/models-mql.js'][768]++;
  xml += "</constraints>\n";
  _$jscoverage['dataapi/models-mql.js'][769]++;
  xml += "<orders>\n";
  _$jscoverage['dataapi/models-mql.js'][770]++;
  for (var idx = 0; (idx < this.state.orders.length); (idx++)) {
    _$jscoverage['dataapi/models-mql.js'][771]++;
...
pentaho.pda.query.mql.prototype.getParameterXML = (function (parameter) {
  ...
  _$jscoverage['dataapi/models-mql.js'][781]++;
  xml += "<parameter defaultValue=\"";
  _$jscoverage['dataapi/models-mql.js'][782]++;
  var defaultValue;
  ...
  if (((column.dataType === pentaho.pda.Column.DATA_TYPES.STRING) || (column.dataType === pentaho.pda.Column.DATA_TYPES.UNKNOWN))) {
    _$jscoverage['dataapi/models-mql.js'][790]++;
    defaultValue = (this.encodeXmlAttribute(defaultValue) || "");
  }
  _$jscoverage['dataapi/models-mql.js'][792]++;
  xml += defaultValue;
  _$jscoverage['dataapi/models-mql.js'][793]++;
  xml += ("\" name=\"" + parameter.name);
  _$jscoverage['dataapi/models-mql.js'][794]++;
...
pentaho.pda.query.mql.prototype.encodeXmlAttribute = (function (value) {
  ...
  _$jscoverage['dataapi/models-mql.js'][801]++;
  var mapping = this.XML_CHARACTER_MAPPING;
  _$jscoverage['dataapi/models-mql.js'][802]++;
...
pentaho.pda.query.mql.prototype.getParameterValueString = (function (column, value) {
  ...
  if (((value == null) || (value == ""))) {
    _$jscoverage['dataapi/models-mql.js'][809]++;
    return "";
  }
  _$jscoverage['dataapi/models-mql.js'][811]++;
  if ((value.constructor.toString().indexOf("Array") != -1)) {
    _$jscoverage['dataapi/models-mql.js'][813]++;
    var str = "";
    _$jscoverage['dataapi/models-mql.js'][814]++;
    for (var idx = 0; (idx < value.length); (idx++)) {
      _$jscoverage['dataapi/models-mql.js'][815]++;
      if ((idx > 0)) {
  ...
  _$jscoverage['dataapi/models-mql.js'][822]++;
...
pentaho.pda.query.mql.prototype.getSelectionXML = (function (selection) {
  _$jscoverage['dataapi/models-mql.js'][835]++;
  if ((selection && selection.id && selection.category)) {
    _$jscoverage['dataapi/models-mql.js'][836]++;
    var xml = "";
    _$jscoverage['dataapi/models-mql.js'][837]++;
    xml += "<selection>\n";
    _$jscoverage['dataapi/models-mql.js'][838]++;
    ...
    _$jscoverage['dataapi/models-mql.js'][845]++;
    ...
    _$jscoverage['dataapi/models-mql.js'][849]++;
    return "";
  }
});
_$jscoverage['dataapi/models-mql.js'][853]++;
pentaho.pda.query.mql.prototype.getSortXML = (function (sort) {
  _$jscoverage['dataapi/models-mql.js'][854]++;
  if ((! sort)) {
    _$jscoverage['dataapi/models-mql.js'][855]++;
    return;
  }
  _$jscoverage['dataapi/models-mql.js'][857]++;
  var xml = "";
  ...
  _$jscoverage['dataapi/models-mql.js'][861]++;
...
pentaho.pda.query.mql.prototype.getFilterXML = (function (filter, parameters) {
  ...
  xml += "<constraint>\n";
  _$jscoverage['dataapi/models-mql.js'][869]++;
  xml += ("<operator>" + filter.combinationType + "</operator>\n");
  _$jscoverage['dataapi/models-mql.js'][870]++;
...
pentaho.pda.query.mql.prototype.getFilterConditionString = (function (columnId, category, operator, value, parameterized, parameters, aggregationType) {
  ...
  var column = this.model.getColumnById(columnId);
  _$jscoverage['dataapi/models-mql.js'][878]++;
  var operand = ("[" + category + "." + columnId + (aggregationType? ("." + aggregationType): "") + "]");
  _$jscoverage['dataapi/models-mql.js'][879]++;
  ...
  if ((operator == pentaho.pda.Column.CONDITION_TYPES.LIKE)) {
    ...
    if (((operator == pentaho.pda.Column.CONDITION_TYPES.EQUAL) && ((! isArrayValues) || (value.length == 1)))) {
      ...
      if (((operator == pentaho.pda.Column.CONDITION_TYPES.EQUAL) && isArrayValues)) {
        ...
        _$jscoverage['dataapi/models-mql.js'][889]++;
...
_$jscoverage['dataapi/models-mql.js'][921]++;
pentaho.pda.query.mql.prototype.getFilterValueString = (function (column, value, parameterized, parameters) {
  ...
  if (parameterized) {
    ...
    for (var idx = 0; (idx < parameters.length); (idx++)) {
      ...
      if ((parameters[idx].name === value[0])) {
        ...
        if ((column.dataType == pentaho.pda.Column.DATA_TYPES.DATE)) {
          _$jscoverage['dataapi/models-mql.js'][933]++;
          param = ("DATEVALUE(" + param + ")");
        }
        _$jscoverage['dataapi/models-mql.js'][935]++;
        return param;
      }
}
  ...
  _$jscoverage['dataapi/models-mql.js'][941]++;
  if ((value.constructor.toString().indexOf("Array") != -1)) {
    _$jscoverage['dataapi/models-mql.js'][943]++;
    var str = "";
    _$jscoverage['dataapi/models-mql.js'][944]++;
    for (var idx = 0; (idx < value.length); (idx++)) {
      _$jscoverage['dataapi/models-mql.js'][945]++;
      if ((idx > 0)) {
  ...
  _$jscoverage['dataapi/models-mql.js'][952]++;
  if ((column.dataType == pentaho.pda.Column.DATA_TYPES.NUMERIC)) {
    _$jscoverage['dataapi/models-mql.js'][953]++;
    return ("" + value);
  }
  _$jscoverage['dataapi/models-mql.js'][955]++;
  if ((column.dataType == pentaho.pda.Column.DATA_TYPES.DATE)) {
